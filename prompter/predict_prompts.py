...
test_files = np.load(f'../segmentor/datasets/{dataset}_test_files.npy', allow_pickle=True)
process_files(test_files)

try:
    val_files = np.load(f'../segmentor/datasets/{dataset}_val_files.npy', allow_pickle=True)
